...
describe("every file:line these pages cite into the engine resolves", () => {
  ...
  const ANCHORS: [string, number, string][] = [
    ...
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 3313, "Wegstein"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 3319, "recycleWegsteinQmin"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 3320, "recycleWegsteinQmax"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 3339, "normL2(gx, x)"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 1986, "v.push_back(s.F)"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 2027, "z /= zsum"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 3415, "s.F * (i < s.z.size()"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 3458, "latent under-convergence"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 3483, "/ scale[i]"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 2058, "mixes flows and"],
    ...
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4330,
      "Flowsheet::validateSequentialPlan"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4420, "MISSING TEAR"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4428, "INVALID ORDER"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4456, "INLET TEAR"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4463, "UNCONSUMED TEAR"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4474, "FORWARD TEAR"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4486, "OFF-CYCLE TEAR"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4543, "[plan] material recycle"],
    ["src/unitOperations/flowsheet/Flowsheet.cpp", 4471, "c <= p->second"],
    // --- the QP
