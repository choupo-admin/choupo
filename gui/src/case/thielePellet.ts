...
export const THIELE_LIMITS: readonly ToolLimit[] = [
  ...
  },
  {
    ...
    body: "The record (constant/assets/aluminaSphere3mm.dat) declares "
      ...
      + "conventionally reported between 2 and 7 — and because D_eff goes as "
      + "1/tau, phi goes as sqrt(tau), so that whole spread moves eta by at "
      + "most sqrt(7/2) = 1.87x however large phi grows, and by about 1.5x at "
      + "this witness's modulus (eta 0.74 to 0.51 against the 0.666 the "
      + "golden pins). The tau knob is there so you read the actual "
      + "sensitivity instead of a remembered factor. "
