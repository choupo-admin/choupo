...
% The tool's declared anchor, as the registry writes it.
...
liquid to pull apart.  Published tables are at \SI{25}{\celsius}; a
...
($\delta \approx \SI{26}{\mega\pascal\tothe{0.5}}$) and nitromethane
($\approx \SI{25.1}{}$) sit almost on top of each other, and a formulator
...
($\approx \SI{48}{\mega\pascal\tothe{0.5}}$), far from every organic on
