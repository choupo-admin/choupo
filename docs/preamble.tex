...
\fancyfoot[C]{\small\sffamily Choupo-v0.2.0}
...
% Manual authorship: the Developer Guide is V\'itor Geraldes alone (he authored
% the code it documents); the other manuals are co-authored with Pedro Mendes.
% A guide opts into the solo credit by defining \soloDevAuthor before the call.
\newcommand{\manualauthors}{\ifdefined\soloDevAuthor V\'{\i}tor Geraldes\else V\'{\i}tor Geraldes and Pedro Mendes\fi}
