...
(2021) 272, doi:10.3390/membranes11040272, published under CC~BY~4.0.  It is
written so that the authors of that paper can check it.  Every number in the
...
is the formulation of Yaroshchuk, Bruening and Lic\'on Bernal, J.\ Membr.\
Sci.\ 447 (2013) 463, and it has a property the engine checks rather than
...
ion permeances fitted with the SDEM trace solution (Eq.~(3)), all in
...
The authors' Eq.~(3) is the analytical solution for a trace ion in the
