...
## 1. Why an index, when 76 records already exist
...
- Of 76 design records, **38 state a rejected alternative and 38 do not** —
...
**38 of 76 records state no rejected alternative.**  For a FORUM or a STUDY
