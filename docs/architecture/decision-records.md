...
## 1. Why an index, when 85 records already exist
...
- Of 85 design records, **42 state a rejected alternative and 43 do not** —
...
**43 of 85 records state no rejected alternative.**  For a FORUM or a STUDY
