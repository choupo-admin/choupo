...
## 1. Why an index, when 71 records already exist
...
- Of 71 design records, **34 state a rejected alternative and 37 do not** —
...
**37 of 71 records state no rejected alternative.**  For a FORUM or a STUDY
