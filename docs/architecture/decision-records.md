...
## 1. Why an index, when 37 records already exist
...
- Of 37 design records, **15 state a rejected alternative and 22 do not** —
...
**22 of 37 records state no rejected alternative.**  For a FORUM or a STUDY
