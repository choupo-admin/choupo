...
## 1. Why an index, when 86 records already exist
...
- Of 86 design records, **43 state a rejected alternative and 43 do not** —
...
**43 of 86 records state no rejected alternative.**  For a FORUM or a STUDY
