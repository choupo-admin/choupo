...
## 1. Why an index, when 88 records already exist
...
- Of 88 design records, **45 state a rejected alternative and 43 do not** —
...
**43 of 88 records state no rejected alternative.**  For a FORUM or a STUDY
