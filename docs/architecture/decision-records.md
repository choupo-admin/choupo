...
## 1. Why an index, when 49 records already exist
...
- Of 49 design records, **22 state a rejected alternative and 27 do not** —
...
**27 of 49 records state no rejected alternative.**  For a FORUM or a STUDY
