...
## 1. Why an index, when 70 records already exist
...
- Of 70 design records, **33 state a rejected alternative and 37 do not** —
...
**37 of 70 records state no rejected alternative.**  For a FORUM or a STUDY
