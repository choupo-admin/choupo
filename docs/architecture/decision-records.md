...
## 1. Why an index, when 72 records already exist
...
- Of 72 design records, **35 state a rejected alternative and 37 do not** —
...
**37 of 72 records state no rejected alternative.**  For a FORUM or a STUDY
