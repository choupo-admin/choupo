...
## 1. Why an index, when 84 records already exist
...
- Of 84 design records, **42 state a rejected alternative and 42 do not** —
...
**42 of 84 records state no rejected alternative.**  For a FORUM or a STUDY
