...
## 1. Why an index, when 36 records already exist
...
- Of 36 design records, **15 state a rejected alternative and 21 do not** —
...
**21 of 36 records state no rejected alternative.**  For a FORUM or a STUDY
