...
## 1. Why an index, when 87 records already exist
...
- Of 87 design records, **44 state a rejected alternative and 43 do not** —
...
**43 of 87 records state no rejected alternative.**  For a FORUM or a STUDY
