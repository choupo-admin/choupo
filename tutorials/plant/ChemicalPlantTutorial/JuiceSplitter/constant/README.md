# JuiceSplitter — own data folder

This unit op's OWN `constant/`: it INHERITS the sector/plant thermoPhysPropDict by
...
- `thermoPhysPropDict`              its own model, when it needs one (then it overrides)
